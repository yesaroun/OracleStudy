...
/*
기존
REGION_ID_NN               REGIONS   C   REGION_ID       "REGION_ID" IS NOT NULL   
REG_ID_PK               REGIONS   P   REGION_ID   
새로만든거 
REGIONS4_REGION4_ID_PK   REGIONS4   P   REGION4_ID      
REGIONS4_REGION4_NAME_NN   REGIONS4   C   REGION4_NAME      "REGION4_NAME" IS NOT NULL   
*/
...
-- 제약조건 이름 변경
ALTER TABLE EMPLOYEES4
RENAME CONSTRAINT SYS_C007124 TO EMP4_LAST_NAME_NN;

ALTER TABLE EMPLOYEES4
RENAME CONSTRAINT SYS_C007125 TO EMP4_EMAIL_NN;

ALTER TABLE EMPLOYEES4
RENAME CONSTRAINT SYS_C007126 TO EMP4_HIRE_DATE_NN;

ALTER TABLE EMPLOYEES4
RENAME CONSTRAINT SYS_C007127 TO EMP4_JOB_ID_NN;
...
INSERT INTO 
            EMPLOYEES4 (EMPLOYEE_ID, FIRST_NAME, LAST_NAME, EMAIL, PHONE_NUMBER, HIRE_DATE, JOB_ID, SALARY) 
SELECT 
...
---------DE4 데이터 입력 후 
UPDATE EMPLOYEES4 E4
SET    E4.DEPARTMENT_ID = (select E.DEPARTMENT_ID
                  from EMPLOYEES E
                  where E4.EMPLOYEE_ID = E.EMPLOYEE_ID);
                  
UPDATE EMPLOYEES4 E4
SET    E4.MANAGER_ID = (select E.MANAGER_ID
                  from EMPLOYEES E
                  where E4.EMPLOYEE_ID = E.EMPLOYEE_ID);
                  
UPDATE EMPLOYEES4 E4
SET    E4.COMMISSION_PCT = (select COMMISSION_PCT
                  from EMPLOYEES E
                  where E4.EMPLOYEE_ID = E.EMPLOYEE_ID);
